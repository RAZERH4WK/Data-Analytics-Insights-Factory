# -*- coding: utf-8 -*-
"""
Created on Sat Feb 27 12:43:12 2021
...
dfip["Publisher_f"] = dfip["Publisher"].combine_first(dfip["Publisher_ip"]).astype(str) 
...
# New column that contains only the first non na value between the same record
dfin["Publisher"] = dfin["Publisher_f"].combine_first(dfin["Publisher_in"]).astype(str)
...
# Clean non used columns
dfin = dfin.drop(columns = ["Publisher_f","Publisher_in","Country_in", "City_in"])
